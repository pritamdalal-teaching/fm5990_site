...
**Starting Project:** This Rstudio project will serve as the starting point for your analysis.  I suspect that most groups will simply add an Rmarkdown file to this project.  Please add any data files that you generate to the `data` subdirectory.
