...
[All Tutorials and Exercises](fm5990_tutorials_and_exercises_20181112.zip) - this is an R Studio project that contains all the tutorials, exercises, and data sets that will be used in the class.
...
[Python Tutorials](fm5990_python_tutorials_and_exercises_20181204.zip) - this is a zip folder that contains Python tutorials that we will be using this semester.