...
#### 9/5/2018
When working with dataframes, the `$` notation can be combined with the `[]` notation.  In order for this code to run, `options_data.csv` needs to be in your working directory.
